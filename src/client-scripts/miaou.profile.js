...
miaou.userProfile = {
	...
	show: function(){
		...
		miaou.profileTimer = setTimeout(function($user){
			var $message = $user.closest('.message,.notification,.userLine'),
		...
		}, miaou.chat.DELAY_BEFORE_PROFILE_POPUP, $(this).closest('.user'));
	},
	hide: function(){
