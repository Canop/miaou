...
uglifyjs miaou.concat.js --screw-ie8 -cmt --reserved "chat,ed,gui,hist,md,mh,mod,ms,notif,prof,skin,usr,win,ws,wz,games,plugins,mountyhall" --output miaou.min.js --source-map miaou.min.js.map
